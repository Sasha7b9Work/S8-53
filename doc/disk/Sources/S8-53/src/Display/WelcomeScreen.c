...
bool WelcomeScreen_Run()
{
    ...
    Painter_DrawRectangleC(0, 0, 319, 239, COLOR_FILL);
    ...
    Painter_DrawBigText(45, y, 8, "МНИПИ");

    Painter_DrawStringInCenterRect(0, 190, 320, 20, "Для получения помощи нажмите и удерживайте кнопку ПОМОЩЬ");
...
void WelcomeScreen_Update() {
    ...
    for(int num = 0; num < 12; num++) {
        ...
        Painter_DrawLineC(x0, y0, x1, y1, COLOR_WHITE);
    }
    Painter_EndScene();
}
