...
int             NumSubItems(Choice *choice);                // Возвращает количество вариантов выбора в элементе по адресу choice.
...
TypeItem        TypeMenuItem(void *address);                    // Возвращает тип элемента меню по адресу address.
...
void            ShowMenu(bool show);                            // Показать/скрыть меню.
