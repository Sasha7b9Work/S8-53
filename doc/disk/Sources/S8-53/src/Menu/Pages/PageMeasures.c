...
{
    Item_SmallButton, &mspMeasTune, 0,
    {
        "Настройка", "Setup",
...
{
    Item_Choice, &mpMeasures, IsActiveChoiceMeasuresNumber,
    {
        "Количество", "Number"
        ,
...
{
    Item_Choice, &mpMeasures, IsActiveChoiceMeasuresChannels,
    {
        "Каналы", "Channels",
...
{
    Item_Choice, &mpMeasures, IsActiveChoiceMeasuresSignal,
    {
        "Вид", "View",
...
{
    Item_Page, &mpMeasures, IsActiveButtonMeasuresTune,
    {
        "НАСТРОИТЬ", "CONFIGURE",
    ...
    EmptyFuncVV,
    EmptyFuncVV,
    Measure_RotateRegSet
};


// ИЗМЕРЕНИЯ /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
static const Page mpMeasures =          ///< ИЗМЕРЕНИЯ
{
