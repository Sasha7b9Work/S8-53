...
void    Panel_EnableLEDChannel0(bool enable);       // Включить/выключить светодиод КАНАЛ 1.
void    Panel_EnableLEDChannel1(bool enable);       // Включить/выключить светодиод КАНАЛ 2.
