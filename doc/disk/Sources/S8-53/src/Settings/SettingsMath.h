...
#define MATH_RANGE                  (set.math.range)                    ///< SettingsMath.range

#define MATH_MULTIPLIER             (set.math.multiplier)               ///< SettingsMath.multiplier

#define MATH_RSHIFT                 (set.math.rShift)                   ///< SettingsMath.rShift
...
typedef struct
{
    ...
    Multiplier      multiplier;     ///< Множитель масштаба математического сигнала.
